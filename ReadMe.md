...
This Python script allows you to download videos from YouTube using the `pytube` library. Simply provide the URL of the YouTube video you want to download, and the script will handle the rest.
...
3. The script will download the video to your specified directory.
